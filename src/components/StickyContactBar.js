...
function StickyContactBar() {
  return (
    <div className="fixed bottom-8 right-4 flex flex-col space-y-4 z-50">
      {/* Primary Contact */}
      <a
        href="tel:+91-96068 96388"
        className="bg-primary p-3 rounded-full shadow-lg hover:bg-secondary transition flex items-center space-x-2"
      >
        <svg
        ...
        <span className="text-white font-medium">+91-96068 96388</span>
      </a>

      {/* Secondary Contact */}
      <a
        href="tel:+91-9738469945"
        className="bg-primary p-3 rounded-full shadow-lg hover:bg-secondary transition flex items-center space-x-2"
      >
        <svg
          xmlns="http://www.w3.org/2000/svg"
        ...
        <span className="text-white font-medium">+91-9738469945</span>
      </a>

      {/* Email Icon */}
      <a
        href="mailto:enquiry@buildrocdc.com"
        className="bg-primary p-3 rounded-full shadow-lg hover:bg-secondary transition flex items-center space-x-2"
      >
        <svg
          xmlns="http://www.w3.org/2000/svg"
        ...
        <span className="text-white font-medium">enquiry@buildrocdc.com</span>
      </a>
    </div>
  );
}
